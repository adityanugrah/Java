import java.io.*;
	public class okAdit {
		public static void main (String [] agrs) throws Exception {
			...
			double [][] angkamaster	= new double [0][5];
				...
				switch (pilih) {
					...
					case 2:
						...
						for (int i=0 ;i<N; i++) {
							...
							angkamaster	[i][2] = Double.parseDouble(input.readLine ());
							angkamaster	[i][3]	= angkamaster [i][1] - (angkamaster [i][1]*angkamaster[i][2]/100);
							System.out.println ("Harga Setelah Diskon Sebesar\t: " +angkamaster [i][3]);
							System.out.println ("");
						}
					break;
					case 3:
