import java.util.Vector; //memanggil vector
import java.io.*;		//inputan
			...
			do {
				...
				switch (pilih) {
					...
					case 5:
						...
						transaksi1  = new Vector ();
						transaksi2  = new Vector ();
						transaksi3  = new Vector ();
						transaksi4  = new Vector ();
						transaksi5  = new Vector ();
						transaksi6  = new Vector ();
						transaksi7  = new Vector ();
						transaksi8  = new Vector ();
						transaksi9  = new Vector ();
						transaksi10 = new Vector ();
						transaksi11 = new Vector ();
						transaksi12 = new Vector ();
						transaksi13 = new Vector ();
						transaksi14 = new Vector ();
						transaksi15 = new Vector ();
						transaksi16 = new Vector ();
						transaksi17 = new Vector ();
						transaksi18 = new Vector ();
						transaksi19 = new Vector ();
						transaksi20 = new Vector ();
						transaksi21 = new Vector ();
						...
						for (int i=0; i<N;i++){	
							...
							System.out.print ("Masukkan Kode Costumer ke " +(i+1)+"\t: ");
							transaksi3.addElement (input.readLine());
							...
							System.out.print ("Masukkan Kode Barang ke " +(i+1)+"\t: ");
							transaksi9.addElement (input.readLine());
							
							for(int j = 0; j<customer1.size(); j++){
								if (master1.equals (transaksi9)){
									transaksi10 = master2;
									System.out.println ("Kode Jenis Barang ke " +(i+1)+"\t\t: " +transaksi10.elementAt(j));
									transaksi11 = master3;
									System.out.println ("Nama Jenis Barang ke " +(i+1)+"\t\t: " +transaksi11.elementAt(j));
									transaksi12 = master4;
									System.out.println ("Nama Barang ke " +(i+1)+"\t\t: "		+transaksi12.elementAt(j));
									
									transaksi13 = master5;
									System.out.println ("Berat Barang (gr) ke " +(i+1)+"\t\t: " +transaksi13.elementAt(j));
									transaksi14 = master6;
									System.out.println ("Total Harga Barang ke " +(i+1)+"\t\t: Rp."+transaksi14.elementAt(j));
									transaksi15 = master7;
									System.out.println ("Diskon Barang ke " +(i+1)+"\t\t: Rp."	+transaksi15.elementAt(j) +" %");
									
									transaksi16 = master8;
									System.out.println ("Harga Setelah Diskon ke " +(i+1)+"\t: Rp."+transaksi16.elementAt(j));
									transaksi17 = kota3;
									System.out.println ("Ongkos Kirim ke " +(i+1)+"\t\t: Rp."		+transaksi17.elementAt(j));
									...
									System.out.println ("Jumlah Harus Dibayar ke " +(i+1)+"\t: Rp. " +transaksi21.elementAt(j));
								}
							}
						}
						//hapus atau update
					...
					/*} catch (Exception e) {
						System.err.println("Harap Isi Data");
					}*/
					break;
					case 7:
